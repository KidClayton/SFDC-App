...
namespace SFDC_App.Models.Salesforce
{
    public class Lead
    {
        ...
        [Display(Name = "HubSpot Score")]
        public double? HubSpot_Score__c { get; set; }

        [Display(Name = "Lead Number")]
        [StringLength(30)]
        [Createable(false), Updateable(false)]
        public string Lead_Number__c { get; set; }

        [Display(Name = "Round Robin ID")]
        [Createable(false), Updateable(false)]
        public double? Round_Robin_ID__c { get; set; }

        [Display(Name = "How heard of TVE")]
        [StringLength(120)]
        public string How_heard_of_TVE__c { get; set; }

        [Display(Name = "If Referred, by whom?")]
        [StringLength(120)]
        public string If_Referred_by_whom__c { get; set; }

        [Display(Name = "Email Opened")]
        public bool Email_Opened__c { get; set; }

        [Display(Name = "Warning Email Sent")]
        public bool Warning_Email_Sent__c { get; set; }

        [Display(Name = "MMSUserID")]
        public double? MMSUserID__c { get; set; }

        [Display(Name = "IsPayingCustomer")]
        public bool IsPayingCustomer__c { get; set; }

        [Display(Name = "FFT Started By")]
        [StringLength(20)]
        public string FFT_Started_By__c { get; set; }
